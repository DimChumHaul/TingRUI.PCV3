...
namespace PCChageTermialV3.TingRUI.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        /* 动态配置主界面顶部【操作员功能模块】 */
        public IEnumerable<object> AcceptModuels { get; set; }
        /* 动态配置主界面左边系 【统菜单栏】 */
        public IEnumerable<object> AcceptMenus { get; set; }
        ...
        {
            AcceptModuels = new List<dynamic> {
                new { Name = "收费设置" },
                new { Name = "车场设置" },
                new { Name = "车道设置" },
                new { Name = "部门管理" },
